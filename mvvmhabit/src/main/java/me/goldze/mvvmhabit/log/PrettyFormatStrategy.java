...
import static me.goldze.mvvmhabit.log.Utils.checkNotNull;
...
public class PrettyFormatStrategy implements FormatStrategy {
  ...
  @NonNull private final DiskLogStrategy diskStrategy;
  @Nullable private final String tag;
  @NonNull private final SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss.SSS", Locale.UK);
  private PrettyFormatStrategy(@NonNull Builder builder) {
    ...
    diskStrategy = builder.diskStrategy;
    tag = builder.tag;
  }
  ...
  private void logTopBorder(int logType, @Nullable String tag) {
    logChunk(true,logType, tag, TOP_BORDER);
  }
  ...
  public static class Builder {
    ...
    @Nullable DiskLogStrategy diskStrategy;
    ...
    @NonNull public PrettyFormatStrategy build() {
      if (logStrategy == null) {
        ...
        if(folder == null){
          ...
          folderStr = diskPath + File.separatorChar + "logger";
        }else {
          folderStr = folder;
        }
